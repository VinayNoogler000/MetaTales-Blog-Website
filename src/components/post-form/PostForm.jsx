...
import {postService, imageService} from "../../appwrite/index";
...
export default function PostForm({post}) {
    ...
    const submit = async (data) => {
        const file = data.image[0] ? imageService.uploadFile(data.image[0]) : null;   
        
        if (post) {
            if (file) await imageService.deleteFile(post.featuredImage)
